...
public class MyUtil
{
	...
	public String pageIndexList(int current_page, int total_page, String list_url,String bid, String mid)
	{
		...
		while (page <= total_page && (page <= currentPageSetup + numPerBlock))
		{
			...
			{
				sb.append("<li><a href='" + list_url + "pageNum=" + page + "&bid="+bid +"&mid="+mid+ "'>" + page + "</a></li>");
			}
			page++;
		}
		...
		if (total_page - currentPageSetup > numPerBlock)
		{
			sb.append("<li>[<a href='" + list_url + "pageNum=" + n +"&bid="+bid+"&mid="+mid+ "'>Next</a>]</li>");
			sb.append("<li><a href='" + list_url + "pageNum=" + total_page +"&bid="+bid+"&mid="+mid+ "'>" + total_page + "</a></li>");
		}
